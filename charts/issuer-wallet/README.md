...
| `wallet.issuer.statuslist.callbackAddress`| string | `https://{ wallet.ingresses[0].hostname }:{ wallet.endpoints.statuslist.port}{ wallet.endpoints.statuslist.path }` | Callback address for statuslist. |
